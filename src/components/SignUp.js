      ...
      <body>
        <section id="signup-page">
          <div className="flex-row">
            <div className="flex-column column-1-2">
              ...
              <p className="notification-simple">
                <span>
                  At moneyTransfer, we respect your privacy and always treat
                  your personal data securely in compliance with strict data
                    ...
                    <div className="form-field-validation ">
                      ...
                      <div className="form-field-hint-error-handler">
                        <p className="form-field-hint">
                          ...
                          include 1 upper case letter, 1 lower case letter and 1
                          number.
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="checkbox">
                        ...
                        <label for="SenderTermsAndConditionsCheckboxGDPR">
                          <span>
                            ...
                            about our products and special offers, please check
                            this box. You can manage your push notification
                ...
                >
                  <div className="copy-text">
                    <p>
                      ...
                      and <a href="https://www.google.com">Privacy Policy</a>
                    </p>
                  </div>
                </section>
              </form>
